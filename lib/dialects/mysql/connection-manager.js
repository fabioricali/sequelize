'use strict';
/**
 * 2017-01-04 Fixed timezone query by Fabio Ricali from wc
 */
...
ConnectionManager.prototype.connect = function(config) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    var tzOffset = self.sequelize.options.timezone;
    tzOffset = /\//.test(tzOffset) ? momentTz.tz(tzOffset).format('Z') : tzOffset;
    connection.query("SET time_zone = '" + tzOffset + "'"); /* jshint ignore: line */
  });
};
